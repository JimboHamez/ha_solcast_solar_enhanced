...
Housekeeping against the Home Assistant [Integration Quality Scale](https://developers.home-assistant.io/docs/core/integration-quality-scale/checklist) — the four Bronze rules the integration was failing, plus the Gold `entity-translations` and `icon-translations` rules. No behavioural change to tuning, dampening or storage.
